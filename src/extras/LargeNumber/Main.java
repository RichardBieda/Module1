...
public class Main {
    ...
    public static void main(String[] args) throws LargeNumberValueException {
        ...
        LargeNumber con = new LargeNumber("1234567891122334455667788995427845425157674845275194979445652762941576546459542652621975164516725649159167595495", 10);
        con.divide("5427845425167889542512455");
