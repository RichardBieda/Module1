...
class ThreadTestHomework {
    ...
    private final static int MAX_COUNT = 1_000_000; //1_000_000 = 1784293664; 100_000 = 705082704; 10_000 = 50005000; 1_000 = 500500
    ...
    public static void main(String[] args) {
        for (int i = 0; i < TRIES.length; i++) {
            compareThreadEfficiency(TRIES[i]);
        }
    }
}
